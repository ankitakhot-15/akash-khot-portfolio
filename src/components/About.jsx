  ...
  const features = [
    {
      ...
      description:
        "Building scalable, high-performance mobile applications for Android and iOS using Flutter",
    },
    {
      icon: <Globe className="w-8 h-8" />,
      title: "Web Development",
      description:
        "Developing responsive and modern web applications using Flutter Web and REST APIs",
    },
    {
      icon: <Code2 className="w-8 h-8" />,
      title: "Clean & Scalable Code",
      description:
        "Writing maintainable, testable, and scalable code using best practices and design patterns",
    },
  ];
    ...
    >
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 lg:mb-16">
          ...
          >
            <p className="text-base sm:text-lg lg:text-xl text-slate-300 leading-relaxed">
              I am a passionate <span className="text-blue-400 font-semibold">Flutter Developer</span> with
              over <span className="text-cyan-400 font-semibold">3.5+ years</span> of professional experience
              in building high-quality mobile and web applications.
            </p>

            <p className="text-base sm:text-lg lg:text-xl text-slate-300 leading-relaxed">
              I have worked with organizations such as{" "}
              <span className="text-blue-400 font-semibold">
                Calyx Solutions Pvt. Ltd, Web Cloud Infotech, and Walstar Technologies
              </span>, and also as a freelancer, delivering scalable Flutter solutions across multiple domains.
            </p>

            <p className="text-base sm:text-lg lg:text-xl text-slate-300 leading-relaxed">
              My expertise includes REST API integration, Firebase services, state management using
              <span className="text-blue-400 font-semibold"> GetX, Bloc, and Provider</span>, and deploying
              production-ready applications with a strong focus on performance, clean architecture,
              and user experience.
            </p>
          </motion.div>
        </div>
